...
from vvcli_sdk.api_response import ApiResponse, T as ApiResponseT
import vvcli_sdk.models
from vvcli_sdk import rest
from vvcli_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(vvcli_sdk.models, klass)
