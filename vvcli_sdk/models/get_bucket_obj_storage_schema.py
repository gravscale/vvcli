...
class GetBucketObjStorageSchema(BaseModel):
    """
    GetBucketObjStorageSchema
    """  # noqa: E501

    name: StrictStr
    usage: Optional[GetBucketUsageSchema] = None
    quota: Optional[GetBucketQuotaSchema] = None
    created_at: datetime = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["name", "usage", "quota", "createdAt"]
        ...
        _obj = cls.model_validate(
            {
                "name": obj.get("name"),
                "usage": (
                    GetBucketUsageSchema.from_dict(obj["usage"])
                    if obj.get("usage") is not None
                    else None
                ),
                "quota": (
                    GetBucketQuotaSchema.from_dict(obj["quota"])
